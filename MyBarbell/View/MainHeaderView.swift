...
class MainHeaderView: UIView {
    ...
    lazy var buttonsStackView: UIStackView = {
        let view = UIStackView(arrangedSubviews: [emptyBarButton, unitsTableView])
        view.axis = .vertical
        return view
    }()
...
private extension MainHeaderView {
    func updateView() {
        addSubviews([totalWeightLabel, buttonsStackView])
        setupConstraints()
    }
    ...
    func setupConstraints() {
        ...
        let buttonsStackViewHeight = 30 + 64 + buttonsStackView.spacing
        buttonsStackView.anchor(nil, left: nil, bottom: nil, right: rightAnchor, topConstant: 0, leftConstant: 0, bottomConstant: 0, rightConstant: 0, widthConstant: 0, heightConstant: buttonsStackViewHeight)
        buttonsStackView.centerYAnchor.constraint(equalTo: totalWeightLabel.centerYAnchor).isActive = true
    }
